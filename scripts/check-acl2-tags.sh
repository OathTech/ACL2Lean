...
direct="step defthm defun type-prescription induction qed begin-proof-log rule rules pool-consider pool-subsumed ground-zero-rules event-failed forcing-round verify-guards encapsulate-begin encapsulate-end constraints"
