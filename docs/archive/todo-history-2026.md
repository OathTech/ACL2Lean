# TODO history — the arc journal through 2026-08-19

> Dated record. **Nothing here is the live backlog** — that is
> [`../../TODO.md`](../../TODO.md). This file is what `TODO.md` accumulated
> between 2026-06 and 2026-08-19: a per-arc journal of narrative entries plus
> the completed items, moved out on 2026-08-19 so the live file could become a
> backlog an outsider can read.

## What is in here, and in what order

1. **The arc journal** — the narrative blocks exactly as they stood at the top
   of `TODO.md`, **newest first** (2026-08-18 close-out arc at the top,
   2026-07-08 at the bottom). These are working entries: findings, refutations,
   measurements, ruling records, per-wave state.
2. **The sectioned remainder** — the section headings `TODO.md` used, with the
   prose blocks and every **completed (`- [x]`) item** left in place. The open
   (`- [ ]`) items were the only thing lifted out; they are the live file's
   backlog now.

Both parts are **verbatim**. Nothing was rewritten, condensed, or dropped.

## A note on duplication with the charters

Most arcs also have a charter or a dated note in `docs/plans/` or
`docs/notes/`, and the journal entry for an arc frequently overlaps its
charter's ARC LOG. The entries were kept as **copies rather than replaced by
pointers**, deliberately: spot-checking showed journal entries carrying
corrections and measurements made *after* the charter was written (e.g. the
`SIX tau-basis leaves, not five` correction), and establishing verbatim-ness
per block against 63 plan documents and ~50 notes could not be done reliably.
A wrong "this is a duplicate" call silently destroys a measurement; a
redundant copy costs nothing. The pointers live in the table below instead.

## Arc → charter / design-note pointers

Where an arc named in the journal has a record document, it is here. This is a
reading aid, not a completeness claim.

| arc / branch | record |
| --- | --- |
| `mdd/close-out` (+ `close-out-item2`) | `docs/plans/2026-08-18_close-out-arc-charter.md` |
| `mdd/r4-wave2` | `docs/plans/2026-08-17_r4-wave2-charter.md` |
| `mdd/r4-wave0-refinement` | `docs/plans/2026-08-14_r4-wave0-charter.md` |
| the T1+2 sprint | `docs/plans/2026-08-14_t12-sprint-charter.md` |
| R1 basics widening | `docs/plans/2026-08-14_r1-basics-widening-charter.md` |
| R2 fork batch | `docs/plans/2026-08-14_r2-fork-batch-charter.md` |
| the R-arcs sequencing | `docs/plans/2026-08-13_r-arcs-roadmap.md` |
| basics close-out | `docs/plans/2026-08-13_basics-closeout-charter.md` |
| `mdd/perf-arc` | `docs/plans/2026-08-17_perf-arc-charter.md` |
| the pathfinder (first mirrors) | `docs/plans/2026-08-12_pathfinder-charter.md` |
| the TP-replay arc | `docs/plans/2026-08-12_tp-replay-charter.md` |
| the two-track split | `docs/plans/2026-08-12_two-track-charter.md` |
| the mirror close-out | `docs/plans/2026-08-11_mirror-closeout-charter.md` |
| `mdd/sorting-endgame` | `docs/plans/2026-08-10_sorting-endgame-charter.md` |
| `mdd/equal-descent-restructure` | `docs/plans/2026-08-10_equal-descent-restructure-charter.md` |
| `mdd/sorting-final-closeout` | `docs/plans/2026-08-09_sorting-final-closeout-charter.md` |
| `mdd/phase3-r7b` | `docs/plans/2026-08-08_phase3-r7b-charter.md` |
| phase 3 close-out | `docs/plans/2026-08-08_phase3-closeout-charter.md` |
| `mdd/phase2-equisort` | `docs/plans/2026-08-07_phase2-equisort-charter.md` |
| `mdd/capstone-demo-arc` | `docs/plans/2026-08-06_capstone-demo-arc.md` |
| `mdd/sorting-closeout` | `docs/plans/2026-08-02_sorting-closeout-arc.md` |
| `mdd/sorting-absolute` | `docs/plans/2026-08-01_sorting-absolute-arc.md` |
| `mdd/path-emission` | `docs/plans/2026-07-31_path-emission-subarc.md` |
| `mdd/sorting-completion-2` | `docs/plans/2026-07-30_sorting-completion-2-arc.md` |
| `mdd/validator-lifter` | `docs/plans/2026-07-30_validator-lifter-arc.md` |
| `mdd/equiv-lane` | `docs/plans/2026-07-29_equiv-lane-design.md` |
| `mdd/expand-and-or` | `docs/plans/2026-07-19_expand-and-or-mirror.md` |
| `mdd/perf-ooda` (driver modular refactor) | `docs/plans/2026-07-18_driver-modular-refactor.md` |
| the decrease-prover rework | `docs/plans/2026-07-18_decrease-prover-rework.md` |
| the induction-generality arc | `docs/plans/2026-07-15_induction-generality-design.md`, close-out in `docs/notes/2026-07-18_induction-generality-closeout.md` |
| `mdd/external-knowledge` | `docs/plans/2026-07-10_external-knowledge-design.md` |
| the mapping arc | `docs/notes/2026-07-22_pattern-map.md`, sequencing in `docs/notes/2026-07-23_mapping-plan-impact.md` |
| the G1–G6 generality programme | `docs/plans/2026-06-10_generality-design.md` (architecture reference; L1–L3 bind, status superseded) |
| the governing plan over all of it | `docs/plans/2026-08-12_master-plan.md` |

Audit reports referenced throughout the journal are in `docs/audits/`, by date.

---

# Part 1 — the arc journal (newest first)
...
# Part 2 — the sectioned remainder

The section structure `TODO.md` carried until 2026-08-19, with its prose
blocks and every completed (`- [x]`) item, verbatim. The open (`- [ ]`) items
that lived under these headings were lifted into the live backlog
([`../../TODO.md`](../../TODO.md)) and are the only thing not reproduced here;
some sections are therefore left holding only their completed work.
